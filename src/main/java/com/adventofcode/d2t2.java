...
import static com.adventofcode.d2t1.computeOptocode;
...
public class d2t2 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(optoParamFinder(optoList));

    }

    public static int optoParamFinder(List<Integer> optoList) {
        ...
        for (int i = 0; i < 100; i ++) {
            for (int j = 0; j < 100; j ++) {
                if (computeOptocode(optoList, i, j) == 19690720) {
                    paramA = i;
                    paramB = j;
                    break;
                }
