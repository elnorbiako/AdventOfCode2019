...
public class d1t2 {
    ...
    int fuelSumBase = 3390830;
    int massSumBase = 10173188;

    public static int computeFuelRec(int mass) {


        if (mass <= 5) return mass;

        else return mass + computeFuelRec(mass / 3 - 2);
    ...
    public static void main(String[] args) {
        ...
        //  System.out.println(computeFuelRec(10173188) - 10173188);
        ...
        for (String fuelString: fuelStrings) {
            ...
            fuels.add((computeFuelRec(Integer.parseInt(fuelString)))-(Integer.parseInt(fuelString)));
        }
