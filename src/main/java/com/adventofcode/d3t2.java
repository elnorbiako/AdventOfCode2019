...
import static com.adventofcode.d3t1.move;
...
//        String b = "U98,R91,D20,R16,D67,R40,U7,R15,U6,R7";
        ...
        stepsToInterA.remove(0);
        stepsToInterB.remove(0);

        System.out.println("Steps to Inter A: " + stepsToInterA);
        System.out.println(coordinatesOfIntersectA);

        System.out.println();
        System.out.println("Steps to Inter B: " + stepsToInterB);
        System.out.println(coordinatesOfIntersectB);


        System.out.println();
        System.out.println("Intersections: " + intersectPoints);

        System.out.println(stepsToInterA.size());
        System.out.println(stepsToInterB.size());

        System.out.println("********************");

//        int min = Integer.MAX_VALUE;
//
//        for (int i = 0; i < stepsToInterA.size(); i++) {
//
//            if (stepsToInterA.get(i) + stepsToInterB.get(i) < min) {
//                min = stepsToInterA.get(i) + stepsToInterB.get(i);
//            }
//
//        }

        System.out.println(stepsToInterA.get(0) + stepsToInterB.get(0));
